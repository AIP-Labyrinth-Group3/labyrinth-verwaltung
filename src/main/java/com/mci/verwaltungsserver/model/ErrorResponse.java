...
public class ErrorResponse {
  ...
  */
  @NotNull 
  @Schema(name = "message", example = "Server not found", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @Valid 
  @Schema(name = "timestamp", example = "2025-10-07T14:15:23Z", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
